...
import { Customer, initCustomer } from './customer.ts';
import { Employee, initEmployee } from './employee.ts';
import { ServiceType, initServiceType } from './serviceType.ts';
import { ServiceOrder, initServiceOrder } from './serviceOrder.ts';
import { Attachment, initAttachment } from './attachment.ts';
import { RecurringOrder, initRecurringOrder } from './recurringOrder.ts';
//import { ServiceOrderItem, initServiceOrderItem } from './serviceOrderItem';
import {
  ServiceOrderAssignment,
  initServiceOrderAssignment,
} from './serviceOrderAssignment.ts';
import {
  ServiceOrderStatusHistory,
  initServiceOrderStatusHistory,
} from './serviceOrderStatusHistory.ts';
import { EmployeeServiceType, initEmployeeServiceType } from './employeeServiceType.ts';
import { Notification, initNotification } from './notification.ts';
